  ...
  return (
    <div className="bg-navy text-slate-light min-h-screen relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-2/3 right-0 w-[450px] h-[300px] bg-golden/[0.06] blur-[120px] rounded-full" />
        <div className="absolute bottom-0 left-1/4 w-[700px] h-[400px] bg-mint/[0.07] blur-[80px] rounded-full" />
      </div>
