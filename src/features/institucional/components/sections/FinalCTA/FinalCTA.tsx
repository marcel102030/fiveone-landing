  ...
  return (
    <section className="relative py-20 lg:py-28 overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute top-0 left-0 w-[550px] h-[450px] bg-mint/[0.08] blur-[80px] rounded-full" />
        <div className="absolute bottom-0 right-0 w-[600px] h-[400px] bg-golden/[0.04] blur-[80px] rounded-full" />
      </div>
