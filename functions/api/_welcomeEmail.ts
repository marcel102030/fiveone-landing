// Template compartilhado do e-mail de boas-vindas (credenciais de acesso).
// Usado tanto no cadastro manual (student-created-email) quanto no webhook
// da Hotmart (hotmart-webhook), para que o aluno receba SEMPRE o mesmo
// e-mail bonito, independente de onde a conta foi criada.
