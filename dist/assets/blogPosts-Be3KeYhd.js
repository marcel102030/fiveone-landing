const e=""+new URL("5q-jazz-DIe0uVXW.png",import.meta.url).href,a=""+new URL("hero-journey-tO7smMon.png",import.meta.url).href,o=""+new URL("mulheres5ministerio-gi0c9v26.jpeg",import.meta.url).href,s=""+new URL("Sem espaço para a ansiedade-8fs9pufN.jpg",import.meta.url).href,r=""+new URL("O problema da supervalorização da Pregação em Púlpito-C18yN6zs.jpg",import.meta.url).href,i=""+new URL("voce provavelmente vai para o inferno-CCfN5PkM.jpg",import.meta.url).href,n=""+new URL("chave para identidade-CFiJIc8A.jpg",import.meta.url).href,t=[{id:"jornada-heroi",title:"Encontrando os 5 Ministérios na Jornada do Herói",subtitle:"Como os arquétipos da jornada do herói se relacionam com os cinco ministérios de Cristo",excerpt:"Jesus redefine o arquétipo do herói e entrega à Igreja um caminho de envio, provação e retorno. Descubra como os cinco ministérios aparecem na narrativa que pulsa em toda cultura humana.",imageUrl:a,date:"2024-03-15",author:"Equipe Five One (adaptação Alan Hirsch)",category:"Formação ministerial",tags:["APEST","discipulado","narrativas bíblicas"],takeaways:["O monomito — envio, provação e retorno — encontra seu cumprimento definitivo em Jesus.","Cristo redefine os arquétipos e entrega os cinco dons à Igreja como expressão de seu próprio ministério.","Seguir Jesus é assumir a jornada do herói que forma discípulos e comunidades enviadas."],content:`
    ...
    *Texto adaptado com base em publicações de Alan Hirsch no blog [5Q Central](https://5qcentral.com/blog/).*
    `},{id:"5q-como-jazz",title:"Os 5 Ministérios como jazz",subtitle:"Uma analogia entre o jazz e o APEST para entender como os dons ministeriais funcionam na prática",excerpt:"O APEST funciona como uma banda de jazz: há estrutura, improviso e espaço para cada voz. Veja como os cinco dons soam em harmonia quando lideram juntos.",imageUrl:e,date:"2024-03-10",author:"Equipe Five One (adaptação Alan Hirsch)",category:"Formação ministerial",tags:["APEST","liderança","igreja saudável"],takeaways:["O jazz ilustra a tensão saudável entre estrutura e improviso que o APEST traz para a igreja.","Cada dom se comporta como um instrumento específico, mas a beleza surge quando todos tocam em harmonia.","O objetivo não é regra rígida, mas maturidade colaborativa guiada pelo Espírito."],content:`
    ...
    ---
    *Texto adaptado com base em publicações de Alan Hirsch no blog [5Q Central](https://5qcentral.com/blog/).*
    `},{id:"5q-identidade",title:"Os 5 Ministérios é a chave para a nossa identidade?",subtitle:"Uma reflexão sobre como o APEST se relaciona com nossa identidade em Cristo",excerpt:"Os dons revelam nossa inclinação, mas nossa identidade está enraizada em Cristo. Como usar o APEST como ferramenta de serviço, não como rótulo.",imageUrl:n,date:"2024-03-10",author:"Equipe Five One (adaptação Alan Hirsch)",category:"Formação ministerial",tags:["identidade","APEST","discipulado"],takeaways:["A identidade primária do discípulo está em Cristo, não no dom predominante.","APEST serve como framework de desenvolvimento e serviço, não como prisão de rótulos.","Somos chamados a crescer em todos os dons, seguindo o modelo completo de Jesus."],content:`
    ...
    ---
    *Texto adaptado com base em publicações de Alan Hirsch no blog [5Q Central](https://5qcentral.com/blog/).*
    `},{id:"mulheres-5-ministerios",title:"Mulheres e os 5 Ministérios de Efésios 4",subtitle:"Uma leitura bíblica sobre a liderança feminina nos dons apostólicos, proféticos, evangelísticos, pastorais e de ensino",excerpt:"Evidências bíblicas mostram mulheres atuando como apóstolas, profetas, evangelistas, pastoras e mestras. Um convite para restaurar esse espaço no corpo de Cristo.",imageUrl:o,date:"2025-04-19",author:"Marcelo Junior da Silva",category:"Teologia bíblica",tags:["liderança","mulheres","Efésios 4"],takeaways:["O Novo Testamento registra mulheres servindo em todos os dons de Efésios 4.","Júnia, Priscila, as filhas de Filipe e outras evidenciam liderança feminina ativa.","Honrar esses exemplos fortalece a missão e reflete o propósito original de Cristo."],content:`
...
`},{id:"supervalorização_Pregação_Púlpito",title:"O problema da supervalorização da Pregação em Púlpito",subtitle:"Por que a centralização no púlpito distorce a vida da igreja bíblica",excerpt:"A igreja do Novo Testamento florescia na mesa e nos lares, não em um palco. Como resgatar a mutualidade, o discipulado e a liderança plural que formam discípulos de verdade.",imageUrl:r,date:"2025-06-11",author:"Marcelo Junior da Silva",category:"Vida comunitária",tags:["discipulado","igreja simples","liderança plural"],takeaways:["A centralização no púlpito enfraquece a mutualidade e a vida de corpo.","O padrão bíblico privilegia mesa, discipulado cotidiano e liderança plural.","Reformar a prática é trocar consumo por comunhão e missão compartilhada."],content:`
...
Teólogo e discipulador apaixonado pela Igreja Viva e pelos fundamentos apostólicos do Novo Testamento.
    `},{id:"Você_provavelmente_inferno",title:"Você provavelmente vai para o inferno",subtitle:"O perigo real de um evangelho sem arrependimento",excerpt:"Jesus falou mais sobre o inferno do que qualquer outro. Um alerta contra a religiosidade sem conversão e um convite urgente ao arrependimento que transforma.",imageUrl:i,date:"2025-06-11",author:"Marcelo Junior da Silva",category:"Evangelismo",tags:["arrependimento","santidade","evangelho"],takeaways:["Religiosidade sem novo nascimento não salva; arrependimento é indispensável.","Jesus tratou o inferno como realidade e advertiu sobre falso sentimento de segurança.","Há esperança plena para quem se rende à graça e ao senhorio de Cristo."],content:`
...
Teólogo, evangelista e defensor de um Evangelho fiel à Palavra de Deus.
  `},{id:"sem_espaco_para_ansiedade",title:"Sem espaço para a ansiedade",subtitle:"Como Jesus nos ensina a vencer a ansiedade confiando radicalmente em Deus",excerpt:"Em Mateus 6, Jesus confronta a cultura do medo e da autossuficiência, oferecendo a confiança em Deus como caminho para vencer a ansiedade. Descubra como a fé, a renovação da mente e a busca pelo Reino transformam nossa relação com o futuro.",imageUrl:s,date:"2025-06-11",author:"Rodolfo Henner",category:"Vida emocional",tags:["ansiedade","discipulado","confiança em Deus"],takeaways:["A ansiedade nasce quando confiamos em nós mesmos e no ídolo do controle.","Jesus chama a buscar primeiro o Reino e descansar no cuidado do Pai.","Renovar a mente e treinar os pensamentos substitui o medo por descanso e fé."],content:`
